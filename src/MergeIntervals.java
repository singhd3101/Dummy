/**
 * Attri => https://github.com/lhyqie/InterviewGym/blob/master/src/array/MergeIntervals.java
 */
...
public class MergeIntervals {
	...
	public static List<Interval> mergeIntervals(List<Interval> intervals){
		...
		for (int i = 1; i < intervals.size(); i++) {
			...
			if(itv.s <= top.e){
				if(itv.e > top.e){   // merge them else top covers current interval (just ignore it)
					stack.pop();
